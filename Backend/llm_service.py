...
class TrafficNarrator:
    ...
    def generate_summary(self, context: dict, junction_name: str = "NeuroTraffic"):
        """
                ...
                messages=[
                    {
                        "role": "system",
                        "content": (
                            "You are a helpful traffic assistant for the NeuroTraffic System. "
    ...
    def _construct_prompt(self, context, junction_name="NeuroTraffic"):
